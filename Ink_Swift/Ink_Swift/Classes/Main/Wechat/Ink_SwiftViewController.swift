...
class Ink_SwiftViewController: LXFBaseController {
    ...
    lazy var dataArr: [LXFRecentSessionModel] = {
        ...
        guard let recentSessions = Ink_SwiftTools.shared.getAllRecentSession() else {
            return datas
        }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let count = Ink_SwiftTools.shared.getAllUnreadCount()
        if count > 0 {
...
// MARK:- 初始化
extension Ink_SwiftViewController {
...
extension Ink_SwiftViewController: UITableViewDataSource, UITableViewDelegate {
