//
//  Ink_SwiftTools+Message.swift
//  Ink_Swift
//
//  Created by LXFWeChat on 2017/1/5.
...
//    }
//    // MARK: 发送音频/视频
//    func sendMedia(userId: String?, filePath: String, type: Ink_SwiftMessageType) {
//        guard let userId = userId else { return }
//        let message = NIMMessage()
//        switch type {
//        case .audio:
...
//extension Ink_SwiftTools: NIMChatManagerDelegate {
//    // MARK:- 发送消息的回调
//    // MARK: 即将发送消息回调
