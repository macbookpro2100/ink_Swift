//
//  Ink_SwiftTools.swift
//  Ink_Swift
//
//  Created by LXFWeChat on 2016/12/27.
...
class Ink_SwiftTools: NSObject {
    // 当前聊天的userId
    var currentChatUserId: String?
    
    // MARK:- 代理
    // MARK: 音频代理
    weak var mediaDelegate: Ink_SwiftToolsMediaDelegate?
    // weak var chatDelegate:
    
    static let shared: Ink_SwiftTools = {
        let tools = Ink_SwiftTools()
...
//// MARK:- 代理
//// MARK: 登录相关代理
//extension Ink_SwiftTools: NIMLoginManagerDelegate {
//    // MARK: 自动登录失败的回调
...
//}
//// MARK: 好友管理相关代理
//extension Ink_SwiftTools: NIMUserManagerDelegate {
//    // MARK: 好友添加成功的回调
