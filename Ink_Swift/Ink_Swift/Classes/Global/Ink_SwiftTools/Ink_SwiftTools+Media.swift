//
//  Ink_SwiftTools+Media.swift
//  Ink_Swift
//
//  Created by LXFWeChat on 2017/1/12.
...
protocol Ink_SwiftToolsMediaDelegate: NSObjectProtocol {
    /* ============================== 播放音频的回调 ============================== */
    // 准备开始播放音频
...
enum Ink_SwiftMediaOutputDeviceType {
    case receiver   // 听筒
    case speaker    // 扬声器
}
...
//    // MARK: 切换音频的输出设备
//    func switchAudioOutputDevice(type: Ink_SwiftMediaOutputDeviceType = .speaker) {
...
//extension Ink_SwiftTools: NIMMediaManagerDelgate {
//    /* ============================== 播放音频的回调 ============================== */
//    // MARK: 准备开始播放音频 回调
