//
//  Ink_SwiftTools+Update.swift
//  Ink_Swift
//
//  Created by LXFWeChat on 2017/2/3.
...
//    }
//    // MARK: 更新性别
//    func updateGender(with gender: Ink_SwiftToolsGender) {
...
//// MARK:- 修改用户信息(string)
//extension Ink_SwiftTools {
//    fileprivate func update(with str: String, type: Ink_SwiftToolsUpdateType, gender: NIMUserGender? = nil) {
//        
//        var key: NSNumber!
//        switch type {
//        case .nickName:
