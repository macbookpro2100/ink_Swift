...
class RegisterViewModel {
    ...
    // output:
    let usernameUsable: Observable<InkResult>
    let passwordUsable: Observable<InkResult>
    let repeatPasswordUsable: Observable<InkResult>
    let registerButtonEnabled: Observable<Bool>
    
    let registerResult: Observable<InkResult>
