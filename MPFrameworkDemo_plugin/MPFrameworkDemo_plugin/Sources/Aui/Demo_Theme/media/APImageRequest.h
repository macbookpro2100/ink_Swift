...
/**
 *  当设置imageRequestType这个值的时候， 以imageRequestType的设置值为准；当imageRequestType未设置，则走以前的老逻辑根据originalSize
 *  和zoom的值来决定imageRequestType； 建议设置此值来决定。智能裁切的默认类型为APImageRequestTypeCut
...
@property (nonatomic, copy) APImageDownloadRequestComplete downLoadCompletion;      //完成回调
...
/**
 *  兼容以前的老接口 原始图片的尺寸。当imageRequestType未指定的情况下 根据originalSize和zoom确定请求图片的类型，不建议使用
 */
