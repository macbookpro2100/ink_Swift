...
{
    UIImage *image = [UIImage imageWithColor:[UIColor colorWithRGB:0xd8d8d8] size:CGSizeMake(18, 18)];
    ...
    _singleLists = [[NSMutableArray alloc] initWithArray:@[singleModel1,singleModel2,singleModel3,singleModel4,singleModel5,singleModel6,singleModel7,singleModel8]];
}
...
//    doubleModel4.title = @"用户名";
    ...
    doubleModel7.linkURL = @"http://aui.alipay.net/develop/ios/aulistitem";
...
//    doubleModel7.rightAssistString = @"辅助信息";
    ...
    doubleModel8.linkURL = @"http://aui.alipay.net/develop/ios/aulistitem";
...
//                model.leftImage = [UIImage imageWithColor:RGB_A(0x108ee8, 0.5) size:CGSizeMake(30, 30)];
                ...
                model1.placeholder = [UIImage imageWithColor:RGB_A(0x108ee8, 0.2) size:CGSizeMake(30, 30)];
            ...
            if (indexPath.row != 2) {
                ...
                model.rightImage = [UIImage imageWithColor:RGB_A(0xd8d8d8, 0.8) size:CGSizeMake(30, 30)];
            }
...
//            cell.leftAccessorView = [[AUCheckBox alloc] initWithStyle:AUCheckBoxStyleDefault];//[[UIImageView alloc] initWithImage:[UIImage imageWithColor:[UIColor colorWithRGB:0x108ee9] size:CGSizeMake(30, 39)]];
            ...
            [cell.leftImageView setImage:[UIImage imageWithColor:RGB_A(0x108ee8, 0.2) size:CGSizeMake(30, 30)]];
        }
