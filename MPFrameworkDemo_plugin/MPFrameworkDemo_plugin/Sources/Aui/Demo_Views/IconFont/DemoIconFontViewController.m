...
_array = @[kICONFONT_MAILLIST, kICONFONT_NEWS_WRITE, kICONFONT_NEWS_COMMENT, kICONFONT_NEWS_FAVORITES, kICONFONT_SETTING, kICONFONT_MORE, kICONFONT_BARCODE, kICONFONT_BACK, kICONFONT_COMPLAIN, kICONFONT_SEARCH, kICONFONT_SHARE, kICONFONT_DELETE, kICONFONT_ITEMLIST, kICONFONT_SCANCODE, kICONFONT_DRAGDOWN, kICONFONT_PRAISE, kICONFONT_MAP, kICONFONT_CHECKBOX_SELECTED, kICONFONT_NOTICE, kICONFONT_CANCEL_STYLE1, kICONFONT_USER_ADD, kICONFONT_COMMENT, kICONFONT_CHOOSE, kICONFONT_BILL, kICONFONT_ADD, kICONFONT_USER, kICONFONT_USER_SETTING, kICONFONT_CASHIER, kICONFONT_VOICE, kICONFONT_CANCEL_STYLE2, kICONFONT_CANCEL_STYLE3, KICONFONT_CHECKBOX_NORMAL, kICONFONT_DETAIL, kICONFONT_SYSTEM_RELOAD, kICONFONT_SHH_CYFW, kICONFONT_GROUP_CHAT, kICONFONT_HEART, kICONFONT_CONTACTS, kICONFONT_PHONECONTACTS, kICONFONT_MINUS_SQUARE_O, kICONFONT_PLUS_SQUARE_O, kICONFONT_HELP, kICONFONT_ALIPAYLOGO_H, kICONFONT_ALIPAYLOGO_Z, kICONFONT_GUANZHU, kICONFONT_SYSTEM_ANT, kICONFONT_SYSTEM_ANTTALK, kICONFONT_FIN_EDIT, kICONFONT_SYSTEN_TRIANGLE, kICONFONT_SYSTEN_KEY, kICONFONT_SYSTEM_CANCEL_BOLD, kICONFONT_SYSTEM_INFORMATION, kICONFONT_HANGYE_GIFT, kICONFONT_HANGYE_NOTE, kICONFONT_HANGYE_BUS, kICONFONT_SHENGHUOHAO_V, kICONFONT_SYSTEM_DOWLOAD, kICONFONT_HANGYE_CHENGCHEDOU, kICONFONT_SYSTEM_DEFEATED, kICONFONT_SYSTEM_SERCH, kICONFONT_SYSTEM_DELETEB, kICONFONT_SYSTEM_ADDRESSBOOK, kICONFONT_SYSTEM_CARD, kICONFONT_SYSTEM_CHARGE, kICONFONT_SYSTEM_COMPLAIN, kICONFONT_SYSTEM_COMPLAINT, kICONFONT_SYSTEM_CONCEAL, kICONFONT_SYSTEM_COPY, kICONFONT_SYSTEM_DISLIKE3, kICONFONT_SYSTEM_EXPRESSFEE, kICONFONT_SYSTEM_DISLIKE, kICONFONT_SYSTEM_FRIENDS, kICONFONT_SYSTEM_JINZHI, kICONFONT_SYSTEM_JUJUE, kICONFONT_SYSTEM_INTERNET, kICONFONT_SYSTEM_LOADINGC, kICONFONT_SYSTEM_LOCK, kICONFONT_SYSTEM_LOADINGB, kICONFONT_SYSTEM_PAYMENT, kICONFONT_SYSTEM_PHONEBOOK, kICONFONT_SYSTEM_REMIND, kICONFONT_SYSTEM_SELECT, kICONFONT_SYSTEM_PEOPLENO, kICONFONT_SYSTEM_SHAREB, kICONFONT_SYSTEM_TRACKPARCEL, kICONFONT_SYSTME_EXPRESSDELIV, kICONFONT_SYSTEM_WARNING3, kICONFONT_SYTEM_COLLECT, kICONFONT_SYSTEM_WAIT, kICONFONT_FOLLOW, kICONFONT_SYSTEM_KOUBEIMIAN, kICONFONT_SYSTEM_QUESTION, kICONFONT_CLOSEXIAN, kICONFONT_SYSTEM_MAP2, kICONFONT_EXCLAMATION_CIRCLE_O, kICONFONT_CROSS_CIRCLE_O, kICONFONT_LIKE, kICONFONT_SYSTEM_TIPSXIAN, kICONFONT_SYSTEM_KOUBEIXIAN, kICONFONT_SYSTEM_CLOSEA, kICONFONT_LOEFT, kICONFONT_PHONE, kICONFONT_SYSTEM_TIPS, kICONFONT_SYSYTEM_ADDPERSON, kICONFONT_SYSYTEM_TIXING, kICONFONT_SYSTEM_FRIENDSZ, kICONFONT_SYSTEM_FRIENDSB, kICONFONT_SYSTEM_NOEYE, kICONFONT_KNOWLEDGE_SHAREPIC, kICONFONT_SYSTEM_NOSOUND];;
}
...
_nameArray = @[@"kICONFONT_MAILLIST", @"kICONFONT_NEWS_WRITE", @"kICONFONT_NEWS_COMMENT", @"kICONFONT_NEWS_FAVORITES", @"kICONFONT_SETTING", @"kICONFONT_MORE", @"kICONFONT_BARCODE", @"kICONFONT_BACK", @"kICONFONT_COMPLAIN", @"kICONFONT_SEARCH", @"kICONFONT_SHARE", @"kICONFONT_DELETE", @"kICONFONT_ITEMLIST", @"kICONFONT_SCANCODE", @"kICONFONT_DRAGDOWN", @"kICONFONT_PRAISE", @"kICONFONT_MAP", @"kICONFONT_CHECKBOX_SELECTED", @"kICONFONT_NOTICE", @"kICONFONT_CANCEL_STYLE1", @"kICONFONT_USER_ADD", @"kICONFONT_COMMENT", @"kICONFONT_CHOOSE", @"kICONFONT_BILL", @"kICONFONT_ADD", @"kICONFONT_USER", @"kICONFONT_USER_SETTING", @"kICONFONT_CASHIER", @"kICONFONT_VOICE", @"kICONFONT_CANCEL_STYLE2", @"kICONFONT_CANCEL_STYLE3", @"KICONFONT_CHECKBOX_NORMAL", @"kICONFONT_DETAIL", @"kICONFONT_SYSTEM_RELOAD", @"kICONFONT_SHH_CYFW", @"kICONFONT_GROUP_CHAT", @"kICONFONT_HEART", @"kICONFONT_CONTACTS", @"kICONFONT_PHONECONTACTS", @"kICONFONT_MINUS_SQUARE_O", @"kICONFONT_PLUS_SQUARE_O", @"kICONFONT_HELP", @"kICONFONT_ALIPAYLOGO_H", @"kICONFONT_ALIPAYLOGO_Z", @"kICONFONT_GUANZHU", @"kICONFONT_SYSTEM_ANT", @"kICONFONT_SYSTEM_ANTTALK", @"kICONFONT_FIN_EDIT", @"kICONFONT_SYSTEN_TRIANGLE", @"kICONFONT_SYSTEN_KEY", @"kICONFONT_SYSTEM_CANCEL_BOLD", @"kICONFONT_SYSTEM_INFORMATION", @"kICONFONT_HANGYE_GIFT", @"kICONFONT_HANGYE_NOTE", @"kICONFONT_HANGYE_BUS", @"kICONFONT_SHENGHUOHAO_V", @"kICONFONT_SYSTEM_DOWLOAD", @"kICONFONT_HANGYE_CHENGCHEDOU", @"kICONFONT_SYSTEM_DEFEATED", @"kICONFONT_SYSTEM_SERCH", @"kICONFONT_SYSTEM_DELETEB", @"kICONFONT_SYSTEM_ADDRESSBOOK", @"kICONFONT_SYSTEM_CARD", @"kICONFONT_SYSTEM_CHARGE", @"kICONFONT_SYSTEM_COMPLAIN", @"kICONFONT_SYSTEM_COMPLAINT", @"kICONFONT_SYSTEM_CONCEAL", @"kICONFONT_SYSTEM_COPY", @"kICONFONT_SYSTEM_DISLIKE3", @"kICONFONT_SYSTEM_EXPRESSFEE", @"kICONFONT_SYSTEM_DISLIKE", @"kICONFONT_SYSTEM_FRIENDS", @"kICONFONT_SYSTEM_JINZHI", @"kICONFONT_SYSTEM_JUJUE", @"kICONFONT_SYSTEM_INTERNET", @"kICONFONT_SYSTEM_LOADINGC", @"kICONFONT_SYSTEM_LOCK", @"kICONFONT_SYSTEM_LOADINGB", @"kICONFONT_SYSTEM_PAYMENT", @"kICONFONT_SYSTEM_PHONEBOOK", @"kICONFONT_SYSTEM_REMIND", @"kICONFONT_SYSTEM_SELECT", @"kICONFONT_SYSTEM_PEOPLENO", @"kICONFONT_SYSTEM_SHAREB", @"kICONFONT_SYSTEM_TRACKPARCEL", @"kICONFONT_SYSTME_EXPRESSDELIV", @"kICONFONT_SYSTEM_WARNING3", @"kICONFONT_SYTEM_COLLECT", @"kICONFONT_SYSTEM_WAIT", @"kICONFONT_FOLLOW", @"kICONFONT_SYSTEM_KOUBEIMIAN", @"kICONFONT_SYSTEM_QUESTION", @"kICONFONT_CLOSEXIAN", @"kICONFONT_SYSTEM_MAP2", @"kICONFONT_EXCLAMATION_CIRCLE_O", @"kICONFONT_CROSS_CIRCLE_O", @"kICONFONT_LIKE", @"kICONFONT_SYSTEM_TIPSXIAN", @"kICONFONT_SYSTEM_KOUBEIXIAN", @"kICONFONT_SYSTEM_CLOSEA", @"kICONFONT_LOEFT", @"kICONFONT_PHONE", @"kICONFONT_SYSTEM_TIPS", @"kICONFONT_SYSYTEM_ADDPERSON", @"kICONFONT_SYSYTEM_TIXING", @"kICONFONT_SYSTEM_FRIENDSZ", @"kICONFONT_SYSTEM_FRIENDSB", @"kICONFONT_SYSTEM_NOEYE", @"kICONFONT_KNOWLEDGE_SHAREPIC", @"kICONFONT_SYSTEM_NOSOUND"];;
    ...
    for (NSString *name in _array) {
        if ([UIImage isIconExists:name inFont:kICONFONT_FONTNAME]) {
            NSLog(@"%@存在", name);
        }
        else {
            NSLog(@"%@不存在", name);
    ...
    if (![UIImage isIconExists:@"\U0000e312" inFont:kICONFONT_FONTNAME]) {
        NSLog(@"不存在");
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // 第一列
    {
        ...
        if (![cell.contentView viewWithTag:2]) {
            ...
            label.size = CGSizeMake(180, 10);
            label.origin = CGPointMake(10, 40);
    ...
    // 第二列
    {
        ...
        if (![cell.contentView viewWithTag:4]) {
            ...
            label.size = CGSizeMake(195, 10);
            label.origin = CGPointMake(200, 40);
            [cell.contentView addSubview:label];
        }
