...
- (void)viewDidLoad
{
    ...
    
    {
        ...
        checkbox.origin = CGPointMake(kDemoGlobalMargin, topMargin);
    ...
    
    {
        AUCheckBox *checkbox = [[AUCheckBox alloc] initWithStyle:AUCheckBoxStyleDefault];
        checkbox.checked = NO;
        checkbox.origin = CGPointMake(rightMargin, topMargin);
        [self.view addSubview:checkbox];
...
- (CGFloat)createBottomViews:(CGFloat)topMargin
{
    ...
    AUCheckBox *checkbox = [[AUCheckBox alloc] initWithStyle:AUCheckBoxStyleDefault];
    checkbox.checked = YES;
    checkbox.origin = CGPointMake(kDemoGlobalMargin, newTopMargin);
    [self.view addSubview:checkbox];
