...
- (void)viewDidLoad
{
    ...
    
    {
        ...
        [button1 setTitle:@"主要操作 Normal(AUButtonStyle1)" forState:UIControlStateNormal];
    ...
    {
        AUButton *button1 = [AUButton buttonWithStyle:AUButtonStyle1];
        [button1 setTitle:@"主要操作 Disable(AUButtonStyle1)" forState:UIControlStateNormal];
        button1.enabled = NO;
        [button1 addTarget:self action:@selector(onButtonClicked:) forControlEvents:UIControlEventTouchUpInside];
        button1.frame = CGRectMake(kDemoGlobalMargin, topMargin,self.view.width-kDemoGlobalMargin*2, button1.height);
        [self.view addSubview:button1];
...

    {
        ...
        [button1 setTitle:@"辅助操作 Normal(AUButtonStyle2)" forState:UIControlStateNormal];
        [button1 addTarget:self action:@selector(onButtonClicked:) forControlEvents:UIControlEventTouchUpInside];
        button1.frame = CGRectMake(kDemoGlobalMargin, topMargin,self.view.width-kDemoGlobalMargin*2, button1.height);
        [self.view addSubview:button1];
        topMargin = button1.bottom + 10;
    ...
    {
        AUButton *button1 = [AUButton buttonWithStyle:AUButtonStyle2];
        [button1 setTitle:@"辅助操作 Disable(AUButtonStyle2)" forState:UIControlStateNormal];
        button1.enabled = NO;
        [button1 addTarget:self action:@selector(onButtonClicked:) forControlEvents:UIControlEventTouchUpInside];
        button1.frame = CGRectMake(kDemoGlobalMargin, topMargin,self.view.width-kDemoGlobalMargin*2, button1.height);
        [self.view addSubview:button1];
...

    {
        ...
        [button1 setTitle:@"警告类操作 Normal(AUButtonStyle6)" forState:UIControlStateNormal];
        [button1 addTarget:self action:@selector(onButtonClicked:) forControlEvents:UIControlEventTouchUpInside];
        button1.frame = CGRectMake(kDemoGlobalMargin, topMargin,self.view.width-kDemoGlobalMargin*2, button1.height);
        [self.view addSubview:button1];
        button1.tag = tag++;
    ...
    {
        AUButton *button1 = [AUButton buttonWithStyle:AUButtonStyle6];
        [button1 setTitle:@"警告类操作 Disable(AUButtonStyle6)" forState:UIControlStateNormal];
        button1.enabled = NO;
        [button1 addTarget:self action:@selector(onButtonClicked:) forControlEvents:UIControlEventTouchUpInside];
        button1.frame = CGRectMake(kDemoGlobalMargin, topMargin,self.view.width-kDemoGlobalMargin*2, button1.height);
        [self.view addSubview:button1];
...
//        topMargin = button1.bottom + 10;
    ...
    
    {
        ...
        [button setTitle:@"选项" forState:UIControlStateNormal];
//        button.titleLabel.text = @"sjkajajksdhka";
...

    {
        ...
        button.autoSizeToFits = YES;
//        button.titleLabel.text = @"sjkajajksdhka";
        [button setTitle:@"筛选五个字" forState:UIControlStateNormal];
        button.selected  = YES;
        [self.view addSubview:button];
        button.centerX = self.view.centerX;
        button.tag = 10929829;
    ...
    {
        AUSubscriptButton *button = [[AUSubscriptButton alloc] initWithFrame:CGRectMake(self.view.width/2+ kDemoGlobalMargin/2, topMargin, 300, 30)];
        button.autoSizeToFits = YES;
        [button setTitle:@"筛选项六个字" forState:UIControlStateNormal];
        [self.view addSubview:button];
        button.centerX = self.view.centerX;
//        button.enabled = NO;
        topMargin = button.bottom + 10;
    ...
    
    {
        AUSubscriptButton *button = [[AUSubscriptButton alloc] initWithFrame:CGRectMake(self.view.width/2+ kDemoGlobalMargin/2, topMargin, 300, 30)];
        button.autoSizeToFits = YES;
        [button setTitle:@"筛选项九个字的样式" forState:UIControlStateNormal];
        [self.view addSubview:button];
        button.centerX = self.view.centerX;
        button.selected = YES;
        topMargin = button.bottom + 10;
    ...
    
    {
        AUSubscriptButton *button = [[AUSubscriptButton alloc] initWithFrame:CGRectMake(self.view.width/2+ kDemoGlobalMargin/2, topMargin, 300, 30)];
        button.autoSizeToFits = YES;
        [button setTitle:@"筛选项十个字的样式哦" forState:UIControlStateNormal];
        [self.view addSubview:button];
        button.centerX = self.view.centerX;
        button.selected = YES;
        topMargin = button.bottom + 10;
    ...
    
    {
        AUSubscriptButton *button = [[AUSubscriptButton alloc] initWithFrame:CGRectMake(self.view.width/2+ kDemoGlobalMargin/2, topMargin, 300, 30)];
        button.autoSizeToFits = YES;
        [button setTitle:@"筛选项超过十个字的样式哦" forState:UIControlStateNormal];
        [self.view addSubview:button];
        button.centerX = self.view.centerX;
        button.enabled = NO;
        topMargin = button.bottom + 10;
