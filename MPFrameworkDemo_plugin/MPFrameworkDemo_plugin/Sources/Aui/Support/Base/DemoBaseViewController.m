...
- (void)viewDidLayoutSubviews
{
    ...
    self.headerView.origin = CGPointMake((self.view.width-self.headerView.width)/2, kConentViewTop);
    CGPoint point = self.footerView.origin;
    self.footerView.origin = CGPointMake((self.view.width-self.footerView.width)/2, MAX(self.view.bottom-15-self.footerView.height, point.y));
