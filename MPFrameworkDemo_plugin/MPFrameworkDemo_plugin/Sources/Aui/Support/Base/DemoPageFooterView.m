...
- (void)setupSubView
{
    ...
    self.iconView.origin = CGPointMake(0, (self.height-self.iconView.image.size.height)/2);
    self.titleLabel.origin = CGPointMake(6+self.iconView.right, 0);
    self.subtitleLabel.origin = CGPointMake(self.titleLabel.left, self.titleLabel.bottom);
}
...
- (UIImageView *)iconView
{
    if (!_iconView)
    {
        ...
        _iconView.size = CGSizeMake(15, 15);
